...
public class DblpParsingDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Map<Integer, String> idToAuthor = new HashMap<>(); 
        int nextId = 0;
